          ...
          <form className="text-gray-500 bg-secondary/10 rounded-lg px-6 py-4 flex flex-col lg:flex-row gap-4 lg:gap-x-8 lg:max-w-full ring-1 max-w-md ring-slate-900/5 relative mt-10">
            ...
            <div className="flex flex-col w-full">
              <div className="flex items-center gap-2">
                ...
                <label htmlFor="checkInDate" className="ml-2">
                  Check-in
                </label>
              </div>
              <input
            ...
            <div className="flex flex-col w-full">
              <div className="flex items-center gap-2">
                <img src={assets.calendar} alt="calendarIcon" width={20} />
                <label htmlFor="checkOutDate" className="ml-2">
                  Check-out
                </label>
              </div>
              <input
                ...
                <div className='flex items-start justify-between p-3'>
                  <div>
                    <div className='flex items-center space-x-2'>
                      ...
                      <p className='bg-green-500/20 px-2 py-0.5 rounded-full text-green-600 border-green-500/30'>Agency</p>
                    </div>
                    <p>Agency Office</p>
                  </div>  
