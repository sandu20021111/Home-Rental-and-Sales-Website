...
import { Link, NavLink, Outlet } from "react-router-dom"; // ❌ Outlet removed
        ...
        <div className="max-md:flexCenter flex flex-col justify-between bg-white sm:m-3 md:min-w-[20%] md:min-h-[97vh] rounded-xl shadow">
          <div className="flex flex-col gap-y-6 max-md:items-center md:pt-5">
            ...
            <div className="w-full flex justify-between md:flex-col">
              ...
              <div className="md:hidden flex items-center gap-3 rounded-b-xl p-2 pl-5 lg:pl-10 md:mt-10">
                <UserButton
                  appearance={{
                    elements: {
                      userButtonAvatarBox: {
          ...
          {/* Bottom user (desktop) */}
          <div className="hidden md:flex items-center gap-3 border-t border-slate-900/15 rounded-b-xl p-2 pl-5 lg:pl-10 md:mt-10">
            <UserButton
              appearance={{
                elements: {
                  userButtonAvatarBox: {
