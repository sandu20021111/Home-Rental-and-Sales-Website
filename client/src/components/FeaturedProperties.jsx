...
const FeaturedProperties = () => {
  ...
  <h5> 
    <span className="font-bold">Dispaying 1-9</span> from 3k listings
    </h5>
  <Link to={"/listing"} onClick={()=>scrollTo(0,0)} 
  className="bg-secondart/10 ring-1 ring-slate-900/15 text-white text-2xl roounded-md p-2 flexCenter">
