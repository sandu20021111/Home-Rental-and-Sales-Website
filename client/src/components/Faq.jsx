   ...
   const [openIndex, setOpenIndex] = React.useState(null)
    const faqsData = [
        ...
        },
        {
            ...
            answer: 'Backed using trusted propery data - no extra agents or steps needed.'
        },
        {
      ...
      <div className="flex flex-col gap-y-12 xl:flex-row">
        ...
        <div className="flex-1">
         ...
         <div className="flex-1 flex flex-col justify-center">
          <Title 
        title1={"Home Made for living"}
        title2={"Simplyfying Your Property Search Every Step"}
        ...
        />
                 ...
                 <div className='max-w-xl w-full flex flex-col gap-4 items-start text-left mt-6'>
                    {faqsData.map((faq, index) => (
                        <div key={index} className='flex flex-col items-start w-full'>
                            <div className='flex items-center justify-between w-full cursor-pointer bg-secondary/10  border boeder-slate-900/10 p-2 px-4 rounded-lg' onClick={() => setOpenIndex(openIndex === index ? null : index)}>
